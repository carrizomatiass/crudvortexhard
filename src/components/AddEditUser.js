              ...
              return (
                ...
                >
                  <TextField
                    ...
                    type="text"
                    name="name"
                    label="Name" // Actua como placeholder
                  ...
                  <TextField
                    ...
                    type="email"
                    name="email"
                    label="Email" // Actua como placeholder
                    onChange={handleChange}
                    onBlur={handleBlur}
                    value={values.email}
                    fullWidth
                  ...
                  <TextField
                    ...
                    type="text"
                    name="phone"
                    label="Phone Number" // Actua placeholder
                    onChange={handleChange}
                    onBlur={handleBlur}
                    value={values.phone}
                    fullWidth
                  ...
                  <TextField
                    ...
                    type="text"
                    name="website"
                    label="Website" // Actua como placeholder
                    onChange={handleChange}
                    onBlur={handleBlur}
                  ...
                  >
                    {this.state.user.edit ? 'Update Employee' : 'Add Employee'}
                  </Button>
                </form>
              );
            }}
